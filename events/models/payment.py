...
class SSLCommerzDatum(models.Model):
    ...
    store_amount = models.DecimalField(max_digits=10, decimal_places=2, null=True)
    ...
    currency_amount = models.DecimalField(max_digits=10, decimal_places=2, null=True)
    currency_rate = models.DecimalField(max_digits=10, decimal_places=2, null=True)
